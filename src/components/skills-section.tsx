...
const LanguageLogos: Record<string, React.FC<React.SVGProps<SVGSVGElement>>> = {
    ...
    'React / Next.js': (props) => (
       <svg {...props} role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>React</title><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z" fill="#61dafb"/><path d="M12.49 5.22c-2.34 0-4.34 1.5-4.99 3.55h9.98c-.65-2.05-2.65-3.55-4.99-3.55zM5.51 12c0-1.07.31-2.06.84-2.89H17.6c.53.83.84 1.82.84 2.89s-.31 2.06-.84 2.89H6.35c-.53-.83-.84-1.82-.84-2.89zm6.49 7.78c2.34 0 4.34-1.5 4.99-3.55H7.5c.65 2.05 2.65 3.55 4.99 3.55z"/><circle cx="12" cy="12" r="1.5" fill="#61dafb"/></svg>
    ),
    'Node.js': (props) => (
    ...
    Figma: (props) => (
      <svg {...props} role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>Figma</title><path d="M12 0c6.627 0 12 5.373 12 12s-5.373 12-12 12S0 18.627 0 12 5.373 0 12 0z" fill="#fff"/><path d="M15.18 4.81a2.4 2.4 0 00-2.4 2.4v2.4h2.4V4.81z" fill="#0acf83"/><path d="M12.78 7.21a2.4 2.4 0 00-2.4 2.4v2.4h2.4V7.21z" fill="#a259ff"/><path d="M10.38 9.61a2.4 2.4 0 00-2.4 2.4v2.4h2.4V9.61z" fill="#f24e1e"/><path d="M10.38 14.41a2.4 2.4 0 002.4-2.4h-2.4v2.4z" fill="#ff7262"/><path d="M12.78 14.41a2.4 2.4 0 002.4-2.4h-2.4v2.4z" fill="#1abcfe"/></svg>
    ),
    'Git & GitHub': (props) => (
    ...
    Firebase: (props) => (
      <svg {...props} role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>Firebase</title><path d="M3.682 17.15L11.536 2.47l2.79 5.166-5.22 9.726zM11.536 2.47L9.13 14.457l-2.44-4.52zM16.8 12.825L11.576 2.924 8.785 8.09l5.22 9.725zM16.8 12.825l2.36-4.37-4.8-3.5" fill="#f57c00"/></svg>
    ),
  };
